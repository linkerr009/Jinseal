    ...
    jinseal_register_acf_field_group([
        ...
        'fields' => [
            ...
            [
                ...
                'type' => 'repeater',
                'instructions' => 'Add, remove and reorder the application items shown in the Applications section.',
                'layout' => 'block',
                'button_label' => 'Add Application',
                'sub_fields' => [
                    ['key' => 'field_product_application_icon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'text', 'instructions' => 'Material Symbols name, for example factory or precision_manufacturing.', 'default_value' => 'factory'],
                    ['key' => 'field_product_application_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text', 'required' => 1],
                    ['key' => 'field_product_application_text', 'label' => 'Description', 'name' => 'text', 'type' => 'textarea', 'rows' => 2],
                ],
            ],
            [
            ...
            [
                ...
                'type' => 'relationship',
                'instructions' => 'Select and reorder related products. Five or more products display as a carousel.',
